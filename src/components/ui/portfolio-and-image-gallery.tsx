...
>(
  (
        ...
        if (!prefersReducedMotion) {
          ...
          gsap.to(containerRef.current, {
            ...
            scrollTrigger: {
              ...
              // Lenis already smooths the scroll; a numeric scrub here would
              // smooth it a second time and make the wheel feel disconnected.
              scrub: true,
    ...
    return (
      <div
        ref={mergedRef}
        className={`min-h-screen w-full relative flex flex-col items-center justify-center overflow-hidden ${className}`}
        {...rest}
      >
        <div
        ...
        >
          <ul
            ref={containerRef}
            className={`
              absolute will-change-transform m-0 p-0 list-none
            ...
            style={{
              ...
              // Center via left:50% + negative margin, NOT translateX (GSAP's
              // rotation tween owns the transform property) and NOT margin
              // auto (auto margins resolve to 0 when the wheel is wider than
              // the viewport, pushing it off-center on small screens).
              left: '50%',
                  ...
                  */}
                  <div
                    ...
                    className={`
                      ...
                      focus-visible:ring-2 focus-visible:ring-sunset-warm focus-visible:ring-offset-2 focus-visible:ring-offset-base
